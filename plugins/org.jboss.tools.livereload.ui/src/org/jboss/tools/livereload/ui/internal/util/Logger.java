...
public final class Logger {
	...
	private static final String INFO = JBossLiveReloadUIActivator.PLUGIN_ID + "/info";

	/** The 'debug' level name, matching the .options file. */
	private static final String DEBUG = JBossLiveReloadUIActivator.PLUGIN_ID + "/debug";

	/** The 'trace' level name, matching the .options file. */
	private static final String TRACE = JBossLiveReloadUIActivator.PLUGIN_ID + "/trace";
	...
	public static void error(final String message, final Throwable t) {
		if (JBossLiveReloadUIActivator.getDefault() != null) {
			JBossLiveReloadUIActivator.getDefault().getLog()
					.log(new Status(Status.ERROR, JBossLiveReloadUIActivator.PLUGIN_ID, message, t));
		} else {
	...
	public static void error(final String message) {
		JBossLiveReloadUIActivator.getDefault().getLog()
				.log(new Status(Status.ERROR, JBossLiveReloadUIActivator.PLUGIN_ID, message));
	}
	...
	public static void warn(final String message, final Throwable t) {
		JBossLiveReloadUIActivator.getDefault().getLog()
				.log(new Status(Status.WARNING, JBossLiveReloadUIActivator.PLUGIN_ID, message, t));
	}
	...
	public static void warn(final String message) {
		JBossLiveReloadUIActivator.getDefault().getLog()
				.log(new Status(Status.WARNING, JBossLiveReloadUIActivator.PLUGIN_ID, message));
	}
	...
	public static void info(String message) {
		if (isOptionEnabled(INFO)) {
			JBossLiveReloadUIActivator.getDefault().getLog()
					.log(new Status(Status.INFO, JBossLiveReloadUIActivator.PLUGIN_ID, message));
		}
	}
	...
	private static boolean isOptionEnabled(String level) {
		...
		return JBossLiveReloadUIActivator.getDefault() != null && JBossLiveReloadUIActivator.getDefault().isDebugging()
