...
public class OpenInExternalDeviceWebBrowserViaQRCodeCommandHandler extends AbstractHandler {
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		try {
			OpenInWebBrowserViaLiveReloadUtils.openWithLiveReloadServer(appModule, true, true, new ICallback() {
				@Override
				public
				void execute(IServer liveReloadServer) {
					TitleAreaDialog dialog = new OpenInExternalDeviceWebBrowserViaQRCodeDialog(appModule, Display
